...
export default function BoardSignHTML(props : BoardSignHTMLProps) {
  ...
  return (
    <S.Wrapper>
        ...
        <S.Bottom>
            <S.Text>유튜브</S.Text>
            <S.YouTube onChange={props.onChangeYouTube} placeholder= '  링크를 입력해주세요'></S.YouTube>
        </S.Bottom>

        <S.Bottom>
            <S.Text>사진첨부</S.Text>
            <S.PostArea>
              <S.ImgBtn>+<br></br>Upload</S.ImgBtn>
              <S.ImgBtn>+<br></br>Upload</S.ImgBtn>
              <S.ImgBtn>+<br></br>Upload</S.ImgBtn>
            </S.PostArea>
        </S.Bottom>
        ...
        <S.Bottom>
            <S.Text>메인설정</S.Text>
            <S.SelectArea>
                <S.SelectInput type = "radio"></S.SelectInput><S.SelectText>유튜브</S.SelectText>
                <S.SelectInput type = "radio"></S.SelectInput><S.SelectText>사진</S.SelectText>
            </S.SelectArea>
        </S.Bottom>
